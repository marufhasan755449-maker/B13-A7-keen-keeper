    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          ...
          <span className="footer-logo">KeenKeeper</span>
        </div>
        ...
        <p style={{ color:"#a7c4b5", fontSize:"0.82rem", marginTop:"4px" }}>
          Social Links
        </p>
      ...
      <div style={{ borderTop:"1px solid rgba(255,255,255,0.1)" }}>
        <div className="footer-bottom">
          <span className="footer-bottom-copy">© 2026 KeenKeeper. All rights reserved.</span>
